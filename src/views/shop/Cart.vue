    ...
    <div class="product" v-if="showCart && caculations.total>0">
      <div class="product__header">
        <div class="product__header__all" @click="() => setCartItemsChecked(shopId)">
          <span class="product__header__icon iconfont" v-html="caculations.allChecked ? '&#xe652;': '&#xe667;'">
          </span>
          全选
        </div>
...
const useCartEffect = (shopId) => {
  ...
  return {
    caculations, productList, cleanCartProducts,
...
export default {
  ...
  setup() {
    ...
    return {
      caculations, shopId, productList, cleanCartProducts,
